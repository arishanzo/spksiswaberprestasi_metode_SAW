        ...
        <div class="container">
            <div class="row justify-content-center">
                <div class="col-md-6 text-white text-center mb-2 ml-3 ">
                    <br>
                    <H3 class="text-white">Sistem Pendukung Keputusan Seleksi </H3>

                    <H5 class="text-white">Siswa Berprestasi Di SMK NU LAMONGAN<H5>
        ...
        <div class="container">
            ...
            <div class="collapse navbar-collapse" id="ftco-nav">
                <ul class="navbar-nav ml-auto">
                    <li class="nav-item active"><a href="<?= base_url() ?>/dashboard/index.php" class="nav-link">Home</a></li>
                    <li class="nav-item"><a href="<?= base_url() ?>/user/index.php" class="nav-link">Data User</a></li>
                    <li class="nav-item"><a href="<?= base_url() ?>/siswa/index.php" class="nav-link">Data siswa</a></li>
